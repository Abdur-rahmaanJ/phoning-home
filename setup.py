...
import os
import sys
from phoning_home import __version__
...
setup(
    ...
    description='Phoning home, analytics, leaderboard and storage with 0 setup.',  # Optional
    ...
    url='https://github.com/Abdur-RahmaanJ/phoning-home',  # Optional
    ...
    keywords='phoning-home analytics cloud storage',  # Optional
    ...
    entry_points={"console_scripts": ["phoning_home=phoning_home.__main__:main"]},
)